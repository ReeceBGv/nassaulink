    ...
    return (
      <div className="min-h-screen bg-[#f5f0e8] flex items-center justify-center px-6">
        <div className="max-w-md w-full text-center">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 bg-[#000000] text-white px-6 py-3 rounded-xl font-medium hover:bg-gray-800 transition-colors"
          >
            <ArrowLeft size={18} />
            Back to Home
          </Link>
    ...
    <div className="min-h-screen bg-[#f5f0e8]">
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link href="/" className="text-sm font-medium text-gray-500 hover:text-[#000000] flex items-center gap-1 transition-colors">
            <ArrowLeft size={16} />
            Cancel
          </Link>
        </nav>
      ...
      <main className="max-w-2xl mx-auto px-6 py-10">
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mx-auto mb-3">
            <Building2 size={24} className="text-[#000000]" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            <h2 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
              <Building2 size={18} className="text-[#000000]" />
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-[#000000] focus:ring-2 focus:ring-gray-100 outline-none transition-all"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-[#000000] focus:ring-2 focus:ring-gray-100 outline-none transition-all resize-none"
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100">
            <h2 className="font-semibold text-gray-900 mb-4 flex items-center gap-2">
              <Phone size={18} className="text-[#000000]" />
              Contact Details
            </h2>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#000000] text-white py-3.5 rounded-xl font-semibold hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
