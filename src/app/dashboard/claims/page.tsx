      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/dashboard" className="text-sm font-medium text-gray-600 hover:text-[#000000]">
              Dashboard
            </Link>
      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-xs font-medium px-2.5 py-1 rounded-full bg-gray-50 text-[#000000]">
              {claim.category}
            </span>
          ...
          <div className="grid md:grid-cols-2 gap-2 text-sm">
            ...
            {claim.website && (
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <a href={claim.website} target="_blank" rel="noopener" className="text-[#000000] hover:underline">
